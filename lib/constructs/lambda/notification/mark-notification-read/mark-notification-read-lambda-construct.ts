...
export class MarkNotificationReadLambdaConstruct extends Construct {
  ...
  constructor(scope: Construct, id: string, props: MarkNotificationReadLambdaConstructProps) {
    ...
    const lambdaCodePath = path.join(__dirname, '../../../../functions/lambda/notification/mark-notification-read/mark-notification-read-lambda.ts');
    this.function = new NodejsFunction(this, 'MarkNotificationReadFunction', {
